...
const links = [
  ...
  {
    label: "Email",
    description: "Enviar uma mensagem mais detalhada.",
...
const Contact = () => {
  return (
    <Section id="contato" spacing="compact" className="border-t border-gray-200/80 dark:border-gray-800">
        ...
        <div className="grid gap-10 md:grid-cols-[0.9fr_1.1fr] md:items-start">
          <div>
            ...
            <p className="mt-4 text-base leading-relaxed text-secondary-text dark:text-gray-300">
              Disponível para estágio ou oportunidade júnior em desenvolvimento web/fullstack.
            </p>
          </div>
