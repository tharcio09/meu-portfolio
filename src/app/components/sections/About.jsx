...
// --- ARRAY REORGANIZADO COM DESTAQUES (FEATURED) ---
const skills = [
  // --- Stack Principal (Featured: true) ---
  ...
  // --- Outras Ferramentas (Featured: false) ---
  ...
  return (
    <Section id="sobre-mim">
      ...
      <div className="grid md:grid-cols-5 gap-12 items-center max-w-6xl mx-auto">
        ...
        >
          <p className="text-lg">
            Desenvolvedor <strong className="text-neon-blue">Full-Stack</strong>{" "}
            em início de carreira, com foco em <strong>React</strong>,{" "}
            <strong>Next.js</strong>, <strong>Node.js</strong> e{" "}
            <strong>Tailwind CSS</strong>. Apaixonado por tecnologia e pelo
            processo de transformar ideias em soluções digitais eficientes.
          </p>
          <p className="text-lg">
            Busco uma oportunidade para aplicar e expandir meus conhecimentos,
            valorizando o{" "}
            <strong className="text-neon-purple">aprendizado contínuo</strong> e
            o trabalho em equipe.
          </p>
          <p className="text-lg">
            Minhas principais stacks incluem Front-end (React, Next.js, Tailwind
            CSS), Back-end (Node.js, Prisma, Supabase) e Ferramentas
            (Git/GitHub, Figma, NextAuth).
          </p>
        </motion.div>
      </div>

      {/* --- SEÇÃO FERRAMENTAS (HIERARQUIA VISUAL) --- */}
      <div className="mt-24">
        ...
        {/* 1. CARDS GRANDES (Apenas Featured) */}
        <motion.div
        ...
        {/* 3. PÍLULAS/BADGES (Skills Secundárias) */}
        <motion.div
        ...
        >
          {otherSkills.map((skill) => (
            <motion.div
              ...
              // MUDANÇA AQUI: Adicionei um pouco mais de escala e mantive o 'cursor-default' para não parecer link clicável
      ...
      <div className="mt-24">
        ...
        >
          ...
          <motion.div
            ...
            whileHover={{
              y: -5,
              boxShadow: "0 10px 30px rgba(39, 215, 254, 0.2)",
            }}
          >
            <motion.div
