...
import {
  SiHtml5, SiCss3, SiJavascript, SiTypescript, SiTailwindcss, SiNodedotjs, SiReact,
  SiNextdotjs, SiGit, SiGithub,
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="text-center md:text-left space-y-6">
            <h3 className="text-3xl font-heading font-bold text-primary-text dark:text-light-text">
              Olá, eu sou o <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-blue to-neon-purple">Tharcio</span>
            </h3>
            <p className="text-lg text-secondary-text dark:text-gray-300 leading-relaxed">
              Estudante de <strong>Análise e Desenvolvimento de Sistemas</strong> focado em aprender e praticar desenvolvimento web.
              Atualmente, estou estudando <strong>React</strong>, <strong>Next.js</strong> e <strong>TypeScript</strong>, aplicando esses conhecimentos em projetos pessoais para fixar os conceitos.
            </p>
            <p className="text-lg text-secondary-text dark:text-gray-300 leading-relaxed">
              Busco uma <strong>primeira oportunidade</strong> para aprender com uma equipe real e evoluir profissionalmente.
            </p>
        ...
        <div className="max-w-4xl mx-auto">
             <div className="flex flex-col md:flex-row gap-6">
                <div className="flex-1 p-6 rounded-2xl bg-light-card dark:bg-dark-card border border-gray-200 dark:border-gray-800 flex items-start gap-4 hover:border-neon-blue/30 transition-colors">
                    ...
                    <div>
                      <h4 className="font-bold text-lg text-primary-text dark:text-light-text">Análise e Des. Sistemas</h4>
                      <p className="text-sm text-secondary-text dark:text-gray-400">Anhanguera • Em andamento</p>
                    </div>
                </div>
                ...
                <div className="flex-1 p-6 rounded-2xl bg-light-card dark:bg-dark-card border border-gray-200 dark:border-gray-800 flex items-start gap-4 hover:border-neon-purple/30 transition-colors">
                    ...
                    <div>
                      <h4 className="font-bold text-lg text-primary-text dark:text-light-text">NLW Connect</h4>
                      <p className="text-sm text-secondary-text dark:text-gray-400">Rocketseat • Concluído</p>
                       <a href="https://app.rocketseat.com.br/certificates/861a62ff-782a-4bec-9f04-df3def1002cb" target="_blank" className="text-xs font-semibold text-neon-purple hover:underline mt-1 block">
                        Ver Credencial
                      </a>
                    </div>
                </div>
